    ...
    public class CEmpleado
    {
        ...
        public string actualizaDatos(string comandoSQL, List<string> nuevosDatos)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@idEmpleado", nuevosDatos[0]);
                ...
                nuevosDatos[7] = nuevosDatos[7].Replace('.', ',');
                cmd.Parameters.AddWithValue("@sueldo", Convert.ToDecimal(nuevosDatos[7]));
        ...
        public DataTable obtenerDatos()
        {
            ...
            string sqlCmd = "SELECT * FROM PERSONA.EMPLEADO";
            try
            {
